...
class Config:
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Raven_xx24")
        self.SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/NovaTrusted1")

        self.BOT_NAME = getenv("BOT_NAME", "𝕽𝖆𝖛𝖊𝖓 𝕸𝖚𝖘𝖎𝖈 🎵✘")
